...
const AddStudent = ({ situation }) => {
    ...
    const fields = { name, rollNum, age, gender, phoneNo,dateOfBirth, password, sclassName, adminID, role, attendance }
        ...
        <>
            <div className="register">
                <form className="registerForm" onSubmit={submitHandler}>
                    ...
                    <label>Age</label>
                    <input className="registerInput" type="number" placeholder="Enter student's Age..."
                        value={age}
